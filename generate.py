    ...
    if args.ulysses_size > 1 or args.ring_size > 1:
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Multi-GPU context parallel requires the 'xfuser' package. "
                'Install it with `pip install "xfuser>=0.4.1"`, or run without '
                "`--ulysses_size`/`--ring_size` for plain FSDP multi-GPU inference."
            ) from exc
        init_distributed_environment(
